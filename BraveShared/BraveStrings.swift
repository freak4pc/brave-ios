...
extension Strings {
    ...
    public static let UserWalletGenericErrorTitle = NSLocalizedString("UserWalletGenericErrorTitle", bundle: Bundle.braveShared, value: "Your request is still being processed, please wait", comment: "")
    public static let UserWalletGenericErrorMessage = NSLocalizedString("UserWalletGenericErrorMessage", bundle: Bundle.braveShared, value: "Sorry there was a problem processing your request, please try again.", comment: "")
    public static let UserWalletRetryPopupTitle = NSLocalizedString("UserWalletClosePopupTitle", bundle: Bundle.braveShared, value: "Try again", comment: "")
}
