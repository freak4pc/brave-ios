...
extension AutoContributeSettingsViewController: UITableViewDelegate, UITableViewDataSource {
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    case .monthlyPayment:
      ...
      let controller = BATValueOptionsSelectionViewController(ledger: ledger, options: choices, isSelectionPrecise: false, selectedOptionIndex: selectedIndex) { [weak self] (selectedIndex) in
