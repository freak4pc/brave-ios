  ...
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    case Section.summary.rawValue:
      ...
      case SummaryRows.monthlyPayment.rawValue:
        ...
        let controller = BATValueOptionsSelectionViewController(ledger: state.ledger, options: choices, isSelectionPrecise: false, selectedOptionIndex: selectedIndex) { [weak self] (selectedIndex) in
          guard let self = self else { return }
